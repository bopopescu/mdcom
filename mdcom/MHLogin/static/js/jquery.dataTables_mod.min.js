...
{anStatic[2].className+=" "+oClasses.sPageButton;anStatic[3].className+=" "+oClasses.sPageButton;}}}},"letter_pagination":{"fnInit":function(oSettings,nPaging,fnCallbackDraw)
{var nFirst=document.createElement('span');var nPrevious=document.createElement('span');var nList=document.createElement('span');var nNext=document.createElement('span');var nLast=document.createElement('span');nFirst.innerHTML=oSettings.oLanguage.oPaginate.sFirst;nPrevious.innerHTML=oSettings.oLanguage.oPaginate.sPrevious;nNext.innerHTML=oSettings.oLanguage.oPaginate.sNext;nLast.innerHTML=oSettings.oLanguage.oPaginate.sLast;var oClasses=oSettings.oClasses;var sImageButtonClass=oClasses.sLetterPaginationButton;nFirst.className=oClasses.sPageButton+" "+oClasses.sPageFirst+" "+sImageButtonClass;nPrevious.className=oClasses.sPageButton+" "+oClasses.sPagePrevious+" "+sImageButtonClass;nNext.className=oClasses.sPageButton+" "+oClasses.sPageNext+" "+sImageButtonClass;nLast.className=oClasses.sPageButton+" "+oClasses.sPageLast+" "+sImageButtonClass;nPaging.appendChild(nFirst);nPaging.appendChild(nPrevious);nPaging.appendChild(nList);nPaging.appendChild(nNext);nPaging.appendChild(nLast);$(nFirst).click(function(){if(oSettings.oApi._fnPageChange(oSettings,"first"))
{fnCallbackDraw(oSettings);}});$(nPrevious).click(function(){if(oSettings.oApi._fnPageChange(oSettings,"previous"))
{fnCallbackDraw(oSettings);}});$(nNext).click(function(){if(oSettings.oApi._fnPageChange(oSettings,"next"))
{fnCallbackDraw(oSettings);}});$(nLast).click(function(){if(oSettings.oApi._fnPageChange(oSettings,"last"))
{fnCallbackDraw(oSettings);}});$('span',nPaging).bind('mousedown',function(){return false;}).bind('selectstart',function(){return false;});if(oSettings.sTableId!==''&&typeof oSettings.aanFeatures.p=="undefined")
...
{if(!oSettings.aanFeatures.p)
{return;}
var iPages=Math.ceil((oSettings.fnRecordsDisplay())/oSettings._iDisplayLength);var iPageCount=(oSettings.iLetterPaginationShowPages>iPages)?iPages:oSettings.iLetterPaginationShowPages;var iPageCountHalf=Math.ceil(iPageCount/2);var iCurrentPage=Math.ceil(oSettings._iDisplayStart/oSettings._iDisplayLength)+1;var sList="";var sPageStartLong="",sPageEndLong="";var sPageStartShort="",sPageEndShort="";var sLetterA="",sLetterB="";var sPageClass="";var i,iPageOffset,iCountItems,iFlag;var oClasses=oSettings.oClasses;var iFrontIndex;if(iCurrentPage<iPageCountHalf)
...
iPageOffset=0-(iFrontIndex-1)*oSettings._iDisplayLength;var iBuildIndex=0;var iLetterRange;function _getRowVal(iOffset)
{var olIndex=oSettings.aiDisplay[oSettings._iDisplayStart+iOffset];var tableRow=oSettings.aoData[olIndex]._aData;return tableRow[oSettings.iColumnToSort];}
while(iPageCount--)
{iBuildIndex++;sPageClass="step";if(iBuildIndex==iFrontIndex)
{sPageClass+=" "+oClasses.sPageButtonActive;}
else
{sPageClass+=(iBuildIndex<iFrontIndex)?"-"+(iFrontIndex-iBuildIndex).toString():"+"+(iBuildIndex-iFrontIndex).toString();}
sPageStartLong=_getRowVal(iPageOffset);i=oSettings.fnRecordsDisplay()-(oSettings._iDisplayStart+iPageOffset);iCountItems=(i>=oSettings._iDisplayLength)?(oSettings._iDisplayLength):(i%oSettings._iDisplayLength);sPageEndLong=_getRowVal(iPageOffset+iCountItems-1);iLetterRange=(sPageStartLong.length>sPageEndLong.length)?(sPageStartLong.length):(sPageEndLong.length);iFlag=0;sPageStartShort="";sPageEndShort="";for(i=0;i<iLetterRange&&!iFlag;i++)
{sLetterA=sPageStartLong.charAt(i).toLowerCase();sLetterB=sPageEndLong.charAt(i).toLowerCase();sPageStartShort+=sPageStartLong.charAt(i);sPageEndShort+=sPageEndLong.charAt(i);if(i>0&&sPageStartShort.toLowerCase()!=sPageEndShort.toLowerCase())
{iFlag=1;}}
sList+='<span class="'+oClasses.sPageButton+' '+sPageClass+'">'+sPageStartShort+'-'+sPageEndShort+'</span>';iPageOffset+=oSettings._iDisplayLength;}
var an=oSettings.aanFeatures.p;var anButtons,anStatic,nPaginateList;var fnClick=function(){my_sClasses=$(this).attr('class');my_aClasses=my_sClasses.split(" ");for(i=0;i<my_aClasses.length;i++)
{my_sClass=my_aClasses[i];if(my_sClass.substr(0,4)=="step"&&my_sClass.length>4){if(my_sClass.charAt(4)=="-")
{n=my_sClass.charAt(5);while(n--){oSettings._iDisplayStart-=oSettings._iDisplayLength;}}
else if(my_sClass.charAt(4)=="+")
{n=my_sClass.charAt(5);while(n--){oSettings._iDisplayStart+=oSettings._iDisplayLength;}}
fnCallbackDraw(oSettings);}}
return false;};var fnFalse=function(){return false;};for(i=0,iLen=an.length;i<iLen;i++)
{if(an[i].childNodes.length===0)
{continue;}
nPaginateList=an[i].childNodes[2];nPaginateList.innerHTML=sList;$('span',nPaginateList).click(fnClick).bind('mousedown',fnFalse).bind('selectstart',fnFalse);}}}};_oExt.oSort={"string-asc":function(a,b)
...
{if(this.oFeatures.bServerSide){return this._iDisplayStart+this.aiDisplay.length;}else{return this._iDisplayEnd;}};this.sInstance=null;this.oFeatures={"bPaginate":true,"bLengthChange":true,"bFilter":true,"bSort":true,"bInfo":true,"bAutoWidth":true,"bProcessing":false,"bSortClasses":true,"bStateSave":false,"bServerSide":false};this.aanFeatures=[];this.oLanguage={"sProcessing":"Processing...","sLengthMenu":"Show _MENU_ entries","sZeroRecords":"No matching records found","sInfo":"Showing _START_ to _END_ of _TOTAL_ entries","sInfoEmpty":"Showing 0 to 0 of 0 entries","sInfoFiltered":"(filtered from _MAX_ total entries)","sInfoPostFix":"","sSearch":"Search by Name:","sUrl":"","oPaginate":{"sFirst":"|&#60;","sPrevious":"&#60","sNext":">","sLast":">|"}};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={"sSearch":"","bEscapeRegex":true};this.aoPreSearchCols=[];this.aaSorting=[[0,'asc',0]];this.aaSortingFixed=null;this.asStripClasses=[];this.fnRowCallback=null;this.fnHeaderCallback=null;this.fnFooterCallback=null;this.aoDrawCallback=[];this.fnInitComplete=null;this.sTableId="";this.nTable=null;this.iDefaultSortIndex=0;this.bInitialised=false;this.aoOpenRows=[];this.sDom='lfrtip';this.sPaginationType="two_button";this.iColumnToSort=null;this.iColumnToSortSecondary=null;this.iLetterPaginationShowPages=3;this.iCookieDuration=60*60*2;this.sAjaxSource=null;this.bAjaxDataGet=true;this.fnServerData=$.getJSON;this.iServerDraw=0;this._iDisplayLength=10;this._iDisplayStart=0;this._iDisplayEnd=10;this._iRecordsTotal=0;this._iRecordsDisplay=0;this.bJUI=false;this.oClasses=_oExt.oStdClasses;this.bFiltered=false;this.bSorted=false;}
...
nFilter.className=oSettings.oClasses.sFilter;var sSpace=oSettings.oLanguage.sSearch===""?"":" ";nFilter.innerHTML=oSettings.oLanguage.sSearch+sSpace+'<input type="text" />';var jqFilter=$("input",nFilter);jqFilter.val(oSettings.oPreviousSearch.sSearch.replace('"','&quot;'));jqFilter.keyup(function(e){if(oSettings.iColumnToSort)
{oSettings.aoPreSearchCols[oSettings.iColumnToSort].sSearch=$(this).val();_fnFilterComplete(oSettings,oSettings.oPreviousSearch,1);return;}
...
{fnCallback(oSettings);}});if(oSettings.sPaginationType=="letter_pagination"&&oSettings.iColumnToSort==iDataIndex){var _aaTemp=new Array();var _aSort1=[oSettings.iColumnToSort,'asc'];_aaTemp[0]=_aSort1;if(oSettings.iColumnToSortSecondary)
{var _aSort2=[oSettings.iColumnToSortSecondary,'asc'];_aaTemp[1]=_aSort2;}
oSettings.aaSorting=_aaTemp;_fnSort(oSettings);}}
...
{_fnMap(oSettings.oFeatures,oInit,"bPaginate");_fnMap(oSettings.oFeatures,oInit,"bLengthChange");_fnMap(oSettings.oFeatures,oInit,"bFilter");_fnMap(oSettings.oFeatures,oInit,"bSort");_fnMap(oSettings.oFeatures,oInit,"bInfo");_fnMap(oSettings.oFeatures,oInit,"bProcessing");_fnMap(oSettings.oFeatures,oInit,"bAutoWidth");_fnMap(oSettings.oFeatures,oInit,"bSortClasses");_fnMap(oSettings.oFeatures,oInit,"bServerSide");_fnMap(oSettings,oInit,"asStripClasses");_fnMap(oSettings,oInit,"fnRowCallback");_fnMap(oSettings,oInit,"fnHeaderCallback");_fnMap(oSettings,oInit,"fnFooterCallback");_fnMap(oSettings,oInit,"fnInitComplete");_fnMap(oSettings,oInit,"fnServerData");_fnMap(oSettings,oInit,"aaSorting");_fnMap(oSettings,oInit,"aaSortingFixed");_fnMap(oSettings,oInit,"sPaginationType");_fnMap(oSettings,oInit,"iColumnToSort");_fnMap(oSettings,oInit,"iColumnToSortSecondary");_fnMap(oSettings,oInit,"iLetterPaginationShowPages");_fnMap(oSettings,oInit,"sAjaxSource");_fnMap(oSettings,oInit,"iCookieDuration");_fnMap(oSettings,oInit,"sDom");_fnMap(oSettings,oInit,"oSearch","oPreviousSearch");_fnMap(oSettings,oInit,"aoSearchCols","aoPreSearchCols");_fnMap(oSettings,oInit,"iDisplayLength","_iDisplayLength");_fnMap(oSettings,oInit,"bJQueryUI","bJUI");if(typeof oInit.fnDrawCallback=='function')
