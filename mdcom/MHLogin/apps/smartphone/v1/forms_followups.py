...
class TaskListForm(forms.Form):
	done_from = forms.BooleanField(required=False, widget=MHLCheckboxInput)
	done_to = forms.BooleanField(required=False, widget=MHLCheckboxInput)
	...
	completed = forms.BooleanField(required=False, widget=MHLCheckboxInput)
...
class UpdateTaskForm(forms.Form):
	...
	def clean(self):
		...
		if (not 'due' in data and
			...
			raise forms.ValidationError(_('While all fields are optional, '
